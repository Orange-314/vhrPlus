            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Button ass_3Button = findViewById(R.id.ass_3);//帐套跳转
                        Button emp_3Button = findViewById(R.id.emp_3);//我的跳转

                        emp_3Button.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                new Thread(new Runnable() {
                                    @Override
                                    public void run() {
                                        Intent change = new Intent(MyActivity.this, EmployeeActivity.class);
                        ...
                        ass_3Button.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                new Thread(new Runnable() {
                                    @Override
                                    public void run() {
                                        Intent change = new Intent(MyActivity.this, SalaryActivity.class);
                                        startActivity(change);
                                    }
                                }).start();
                            }
    ...
    public static class DetailsActivity extends Activity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            if (savedInstanceState == null) {
                ...
                HrDetailsFragment details = new HrDetailsFragment();
