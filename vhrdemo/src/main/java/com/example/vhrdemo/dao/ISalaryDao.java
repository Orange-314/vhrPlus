...
public interface ISalaryDao {
    ...
    Salary insert1(@Param("id") int id,@Param("basicSalary") int basicSalary,@Param("bonus") int bonus,@Param("lunchSalary") int lunchSalary,@Param("trafficSalary")int trafficSalary,@Param("allSalary")int allSalary);

    Salary insert(@Param("id") int id,@Param("basicSalary") int basicSalary,@Param("bonus") int bonus,@Param("lunchSalary") int lunchSalary,@Param("trafficSalary")int trafficSalary,@Param("allSalary")int allSalary,@Param("pensionBase")int pensionBase,@Param("pensionPer")float pensionPer,@Param("medicalBase")int medicalBase,@Param("medicalPer")float medicalPer,@Param("accumulationFundBase")int accumulationFundBase,@Param("accumulationFundPer")float accumulationFundPer,@Param("name") String name);
